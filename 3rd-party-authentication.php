...
<div class="wrap">
  ...
  <form action="options.php" method="post">
    ...
    <?php settings_fields('3rd_Party_Authentication'); ?>
...
<!--
    ...
    <?php if (function_exists('settings_fields')): settings_fields('3rd_party_allow_regular,3rd_party_google_apps_dont,3rd_party_google_apps_all,3rd_party_google_apps_domains'); endif; ?>
-->
...
function Third_party_admin_init() {
	//add_option('3rd_party_allow_regular', false, 'Allow regular logins as well as email logins?');
	//add_option('3rd_party_google_apps_dont', false, "Don't authenticate gmail/googlemail logins?");
	//add_option('3rd_party_google_apps_all', false, 'Authenticate all domains via google apps?');
	//add_option('3rd_party_google_apps_domains', '', 'A comma seperated list of domains to authenticate via google apps.');
	register_setting( '3rd_Party_Authentication', '3rd_party_allow_regular', '' );
	register_setting( '3rd_Party_Authentication', '3rd_party_google_apps_dont', '' );
	register_setting( '3rd_Party_Authentication', '3rd_party_google_apps_all', '' );
	register_setting( '3rd_Party_Authentication', '3rd_party_google_apps_domains', '' );
}
add_action( 'admin_init', 'Third_party_admin_init' );
